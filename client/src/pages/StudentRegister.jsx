          ...
          <div className="max-w-5xl mx-auto space-y-5">
            ...
            <form onSubmit={handleSubmit} className="w-full space-y-5">
              ...
              <div className="bg-white border border-slate-200 rounded-2xl p-6 md:p-8 shadow-sm space-y-5">
                ...
                <div className="bg-slate-50/50 border border-dashed border-slate-200 p-4 rounded-xl flex items-center justify-between text-xs font-bold mt-2">
                  <div className="flex items-center gap-2.5">
                    <div className="w-8.5 h-8.5 rounded-lg bg-blue-50 flex items-center justify-center text-blue-600 border border-blue-100/50">
                      <Layers className="w-4.5 h-4.5" />
                    </div>
                    <div>
                      <h5 className="text-[11px] text-slate-850 font-bold">Profile Photo (Optional)</h5>
                      <p className="text-[9px] text-slate-400 font-semibold mt-0.5">Supports high-fidelity verification checks</p>
                    </div>
                  </div>
                  <button type="button" className="px-4 py-2 bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 rounded-lg shadow-sm transition text-[10px]">
                    Choose File
                  </button>
                </div>
              </div>
