      ...
      {user.role === 'ADMIN' && (
        <div className="mb-6 bg-white p-4 rounded shadow border flex items-center gap-4">
          ...
          <NativeSelect
            ...
            className="p-2 border rounded focus:ring-2 focus:ring-blue-500 flex-1 bg-white text-xs font-bold"
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex gap-4">
                <div className="flex-1">
                  ...
                  <NativeSelect name="roomType" value={formData.roomType} onChange={handleChange} className="w-full p-2 border rounded focus:ring-2 focus:outline-none bg-white text-xs font-bold">
                ...
                <div className="flex-1">
                  ...
                  <NativeSelect name="gender" value={formData.gender} onChange={handleChange} className="w-full p-2 border rounded focus:ring-2 focus:outline-none bg-white text-xs font-bold">
